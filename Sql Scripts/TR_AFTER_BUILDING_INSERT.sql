    ...
    SET TOTAL_FLOORS = 1;
		WHILE TOTAL_FLOORS <= NEW.NO_OF_FLOORS DO
			...
			WHILE ROOM_NO <= NEW.FLATS_PER_FLOOR DO
				IF TOTAL_FLOORS BETWEEN 1 AND 5 THEN
					SET COST_PRICE = 100;
					SET SELLING_PRICE = 300;
				ELSEIF TOTAL_FLOORS BETWEEN 6 AND 10 THEN 
						SET COST_PRICE = 300;
                        SET SELLING_PRICE = 500;
				ELSEIF TOTAL_FLOORS BETWEEN 11 AND 15 THEN 
						SET COST_PRICE = 500;
                        SET SELLING_PRICE = 700;
				ELSEIF TOTAL_FLOORS BETWEEN 16 AND 20 THEN 
						SET COST_PRICE = 700;
                        SET SELLING_PRICE = 900;
				ELSEIF TOTAL_FLOORS BETWEEN 21 AND 25 THEN 
						SET COST_PRICE = 900;
